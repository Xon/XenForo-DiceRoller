...
class XfAddOns_RpgFeatures_Route_Prefix_Post implements XenForo_Route_Interface
{
	public function match($routePath, Zend_Controller_Request_Http $request, XenForo_Router $router)
	{
		$action = $router->resolveActionWithIntegerParam($routePath, $request, 'post_id');
		return $router->getRouteMatch('XfAddOns_RpgFeatures_ControllerPublic_Dice', $action);
	}
